...
void Scanner::Init() {
	...
	keywords.set(L"PRODUCTIONS", 7);
	keywords.set(L"END", 10);
	keywords.set(L"NAMESPACE", 11);
	keywords.set(L"OPTIONS", 14);
	keywords.set(L"TAGS", 15);
	keywords.set(L"ATTRS", 16);
	keywords.set(L"PROCESSING_INSTRUCTIONS", 17);
	keywords.set(L"WEAK", 23);
	keywords.set(L"ANY", 28);
	keywords.set(L"SYNC", 29);
	keywords.set(L"IF", 30);
