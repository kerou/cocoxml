	...
	Token NextToken() {
		...
		while (!done) {
			...
			switch (state) {
				...
				case 5:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 65535) {tval[tlen++] = (char)ch; NextCh(); state = 6; break;}
					else if (ch == 92) {tval[tlen++] = (char)ch; NextCh(); state = 7; break;}
					else {t.kind = noSym; done = true; break;}
				case 6:
					if (ch == 39) {tval[tlen++] = (char)ch; NextCh(); state = 9; break;}
					else {t.kind = noSym; done = true; break;}
				case 7:
					if (ch >= ' ' && ch <= '~') {tval[tlen++] = (char)ch; NextCh(); state = 8; break;}
					else {t.kind = noSym; done = true; break;}
				case 8:
					if (ch >= '0' && ch <= '9' || ch >= 'a' && ch <= 'f') {tval[tlen++] = (char)ch; NextCh(); state = 8; break;}
					else if (ch == 39) {tval[tlen++] = (char)ch; NextCh(); state = 9; break;}
					else {t.kind = noSym; done = true; break;}
				case 9:
					{t.kind = 5; done = true; break;}
				case 10:
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {tval[tlen++] = (char)ch; NextCh(); state = 10; break;}
					else {t.kind = 47; done = true; break;}
				case 11:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '[' || ch >= ']' && ch <= 65535) {tval[tlen++] = (char)ch; NextCh(); state = 11; break;}
					else if (ch == 10 || ch == 13) {tval[tlen++] = (char)ch; NextCh(); state = 4; break;}
					else if (ch == '"') {tval[tlen++] = (char)ch; NextCh(); state = 3; break;}
					else if (ch == 92) {tval[tlen++] = (char)ch; NextCh(); state = 12; break;}
					else {t.kind = noSym; done = true; break;}
				case 12:
					if (ch >= ' ' && ch <= '~') {tval[tlen++] = (char)ch; NextCh(); state = 11; break;}
					else {t.kind = noSym; done = true; break;}
				case 13:
				...
				case 31:
					if (ch == '.') {tval[tlen++] = (char)ch; NextCh(); state = 16; break;}
