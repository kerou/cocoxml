...
void
CfScanner_Warning(CfScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
...
void
CfScanner_Error(CfScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
    loc.fname = self->cur->fname;
...
void
CfScanner_Fatal(CfScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
    loc.fname = self->cur->fname;
