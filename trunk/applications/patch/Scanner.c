...
void
PatchScanner_Warning(PatchScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
...
void
PatchScanner_Error(PatchScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
    loc.fname = self->cur->fname;
...
void
PatchScanner_Fatal(PatchScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
    loc.fname = self->cur->fname;
