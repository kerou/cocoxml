...
void
JsonScanner_Warning(JsonScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
...
void
JsonScanner_Error(JsonScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
    loc.fname = self->cur->fname;
...
void
JsonScanner_Fatal(JsonScanner_t * self, const char * format, ...)
{
    va_list ap;
    CcsLocation_t loc;
    loc.fname = self->cur->fname;
...
const char *
JsonScanner_GetString(JsonScanner_t * self, long start, size_t len)
{
    return CcsScanInput_GetString(self->cur, start, len);
}
void
JsonScanner_Consume(JsonScanner_t * self, long start, size_t len)
{
